...
CREATE TABLE `persona` (
  ...
  `per_numero_documento` bigint(20) DEFAULT NULL,
  `tpo_id` int(11) NOT NULL,
  PRIMARY KEY (`per_id`),
  KEY `FKicdks57hjv7573oedrbml46d8` (`tpo_id`)
...
INSERT INTO `persona` VALUES (2,'Pigni','1986-10-06','Maria Paula',32494793,1);
...
INSERT INTO `tipo_documento` VALUES (1,'DNI'),(2,'LIBRETA CIVICA'),(3,'PASAPORTE');
...
-- Dump completed on 2019-05-05  2:55:53
